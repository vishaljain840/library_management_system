...
<body>
        ...
        <div class="reg_img">
            ...
            <div class="box2">
                ...
                <form name="Registration" action="" method="post" >
                    ...
                    <input type="submit" class="btn btn-default" type="submit" name="submit" value="Sign-up" style="color: black; width: 70px; height: 30px;">
                </div>
                </form>
    ...
    if(isset($_POST['submit']))
    {
        ...
        mysqli_query($db,"INSERT INTO `STUDENT` VALUES ('$_POST[first]','$_POST[last]', '$_POST[username]',
         '$_POST[password]', '$_POST[roll]', '$_POST[email]', '$_POST[contact]','username-icon.png');");
