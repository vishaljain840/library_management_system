...
<?php
    ...
    and username='$_SESSION[login_user]' and sender='admin' ;");
    $c = mysqli_fetch_assoc($r);
        $b = mysqli_query($db,"SELECT * FROM issue_book where username = '$_SESSION[login_user]'
        and approved='Yes' ORDER BY `return` ASC limit 0,1 ;");
        $bid = mysqli_fetch_assoc($b);
        $t = mysqli_query($db, "SELECT * from `timer` where name = '$_SESSION[login_user]' and 
        bid = '$bid[bid]' ;");
  ...
  if (distance < 0) {
    ...
    document.getElementById("demo").innerHTML = "EXPIRED";
                ...
                <?php echo $c['total'];  ?></span></a></li>
                    ...
                    <?php
                 echo "<img class='img-circle profile_img' style ='background-color: white; width: 30px; height: 30px;'  src='images/".$_SESSION['pic']."' >";
