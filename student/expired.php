...
<?php
    ...
    if(isset($_SESSION['login_user']))
    {
      ...
      $exp ='<p style="color:yellow; background-color: red;">Expired</p>';
        ...
        issue_book.approved = '$ret' and issue_book.username = '$_SESSION[login_user]' ORDER BY `issue_book`.`return` DESC";
        ...
        name,authors,edition,approved,issue_book.issue,issue_book.return FROM student inner join
        issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE
        issue_book.approved = '$exp' and issue_book.username = '$_SESSION[login_user]'  ORDER BY `issue_book`.`return` DESC";
        $res=mysqli_query($db,$sql);
          ...
          name,authors,edition,approved,issue_book.issue,issue_book.return FROM student inner join
          issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE
          issue_book.approved != '' and issue_book.approved != 'Yes' and issue_book.username = '$_SESSION[login_user]'  ORDER BY `issue_book`.`return` DESC";
          $res=mysqli_query($db,$sql);
