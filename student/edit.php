...
<body style="background-color: #274a27;">
    ...
    <div class="profile_info" style="text-align: center;">
        ...
        <input class="form-control" type="text" name="roll" value="<?php echo $roll ; ?>"><br>
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql1 = "UPDATE student SET     first='$first', last='$last', username='$username',
                 password='$password',  email='$email', contact='$contact', pic='$pic'
